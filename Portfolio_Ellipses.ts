...
const Ellipse_2: Ellipsis_BG = new Ellipsis_BG("110rem", "55rem", "100vh", "65vh", Colors.WG, 30);
const Ellipse_3: Ellipsis_BG = new Ellipsis_BG("100rem", "60rem", "-30vh", "60vh", Colors.SCG, 40);
